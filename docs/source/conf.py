...
project = u'DataShape'
copyright = u'2013-2014, Continuum Analytics'
...
import re
import datashape
from datashape import __version__ as release
...
extlinks = dict(issue=('https://github.com/ContinuumIO/datashape/issues/%s',
                '#'))
